...
// FeedHenry
#define COCOAPODS_POD_AVAILABLE_FeedHenry
#define COCOAPODS_VERSION_MAJOR_FeedHenry 2
#define COCOAPODS_VERSION_MINOR_FeedHenry 2
#define COCOAPODS_VERSION_PATCH_FeedHenry 5

...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  UINavigationController* navController = (UINavigationController*)[rootViewController.viewControllers objectAtIndex:0] ;
  ...
  RootViewCotroller* tableViewController = (RootViewCotroller*) [navController topViewController];
...
- (NSManagedObjectModel *)managedObjectModel
{
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ShoppingItem" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ShoppingItem.sqlite"];

...
- (void) testGetStorageFilePath
{
  ...
  XCTAssertTrue([[filePath lastPathComponent] isEqualToString:fileName], @"filePath is wrong: path = %@", filePath);
}
...
- (void) testGenerateHash
{
  ...
  XCTAssertTrue([hashValue isEqualToString:expectedHashValue], @"Hashvalue generated by ios SDK doesn't match JS SDK. ios = %@ :: js = %@", hashValue, expectedHashValue);
}

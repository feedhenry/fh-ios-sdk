...
/**
 Extensions to standard primitive and collections classes to support easier json parsing.
 Internally, it uses the system provided 'NSJSONSerialization' class to perform the
...
/**
 ...
 @return a JSON String, or nil if an internal error occurs. The resulting data is a encoded in UTF-8.
 */
- (NSString *)JSONString;
...
/**
 ...
 @return a JSON data, or nil if an internal error occurs. The resulting data is a encoded in UTF-8.
 */
- (NSData *)JSONData;
